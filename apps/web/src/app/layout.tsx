...
export const metadata: Metadata = {
  title: 'Agent Smith - AI Terminal Control',
  description: 'Admin dashboard for AI terminal automation',
}
              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  <div className="flex-shrink-0 flex items-center">
                    <h1 className="text-xl font-bold text-gray-900">🤖 Agent Smith</h1>
                  </div>
